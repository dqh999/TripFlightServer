...
public class StationEntity extends BaseEntity {
    ...
    public StationEntity(String id, String name, String country, String city, Double latitude, Double longitude, String phoneNumber, String email, String website, String operatingHours, String status) {
        this.id = id;
        this.name = name;
