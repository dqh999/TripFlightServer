package com.flight.server.application.payment.constant;
...
public class VNPayParams {
    ...
    public static final String IPADDR = "vnp_IpAddr";
    ...
    public static final String EXPIRED_DATE = "vnp_ExpireDate";
